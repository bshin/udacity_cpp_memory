    ...
    : wxScrolledWindow(parent, id)
{
    ...
    _chatLogic = std::make_unique<ChatLogic>();   // change for unique pointer  
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    ...
    // delete _chatLogic;
    // take out delete command since _chatLogic has been changed into smart pointer, takes care of itself
