...
//// STUDENT CODE
////
ChatBot::ChatBot(const ChatBot &ChatBot2){
...
ChatBot::ChatBot(ChatBot &&ChatBot2){
    std::cout << "ChatBot MOVE constructor" << std::endl;
    _chatLogic = ChatBot2._chatLogic;
    _rootNode = ChatBot2._rootNode;
    _image = ChatBot2._image;
    _currentNode = ChatBot2._currentNode;
    ChatBot2._chatLogic = nullptr;
    ChatBot2._rootNode = nullptr;
    ChatBot2._image = NULL;
    ChatBot2._currentNode = nullptr;
}

ChatBot &ChatBot::operator=(ChatBot &&ChatBot2){
